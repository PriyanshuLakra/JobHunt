...
import { fetchSingleJob } from "../Store/Slices/jobSclice";
...
export const PostApplication = ()=>{
    ...
    const {singleJob} = useSelector((state:any) => state.jobs)
    const {isAuthenticated , user } = useSelector((state:any) => state.user)

    const {loading , error , message} = useSelector((state:any) => state.applications);
...
const [role , setRole] = useState("")
  ...
  const handlePostApplication = (e:any) =>{
    e.preventDefault();
            ...
            <div className="wrapper">
              ...
              {singleJob.qualifications && (
                <div>
                  ...
                  <ul>
                    {qualifications.map((element:any) => {
                      return (
              ...
              {singleJob.responsibilities && (
                <div>
                  ...
                  <ul>
                    {responsibilities.map((element:any) => {
                      return (
                        <li key={element} style={{ listStyle: "inside" }}>
                          {element}
                        </li>
